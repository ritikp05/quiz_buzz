...
const[message,Setmesage]=useState("")
  ...
  className=' flex flex-col gap-4 mt-10 bg-slate-400 p-10 rounded-2xl  shadow-lg '>
    ...
    <TextField id="standard-basic" onChange={(e)=>Setmesage(e.target.value)} value={message}  name="message" label="Leave a comment" multiline="true" maxRows={3} variant="standard" />
    </div>   
    <button type="submit" className='bg-red-500 text-white w-1/2 px-4 py-1 rounded-lg mx-auto hover:bg-red-600'>Submit</button>
    </form>
