  ...
  return (
    ...
    <div className='flex flex-col lg:flex-row lg:gap-1  lg:justify-around lg:items-center w-full mt-6 lg:w-full  h-auto lg:h-screen   px-1'>
     ...
     <div className='flex flex-col  gap-1'>
      ...
      <h4 className="text-3xl underline text-gray-500 mx-auto mt-8  lg:mt-5 mb-10  ">Create Your Quiz Profile</h4>
      ...
      <br />
      <button   className='bg-purple-600 hover:bg-purple-800 text-white text-xl py-3 w-72 lg:w-full m-auto  rounded-2xl '  onClick={handleSubmit}>
        Start Quiz
      </button>
    </div>
     </div>
